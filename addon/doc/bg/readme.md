...
въвеждане", категорията "Вмъкване на символи" или "Копиране на символи",
можете да конфигурирате NVDA да въвежда символи чрез зададени за целта
жестове.
...
## Промени във версия 34.0.0

* Добавена е възможност за копиране в клипборда и поставяне на отделни
  символи, което е полезно, когато жестовете, свързани със скриптовете за
  вмъкване на символи, не работят.
