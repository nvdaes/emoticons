...
このダイアログで、NVDAの句読点/記号読み上げダイアログの、利用可能な記号の一つを選択することが出来ます。記号リストから項目を選択するには、フィルターエディットボックスまたは矢印キーを使用することが出来ます。そして、OKを押すと、選択された絵文字または記号がクリップボードにコピーされ、貼り付け可能になります。
